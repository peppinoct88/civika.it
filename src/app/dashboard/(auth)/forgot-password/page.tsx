          ...
          <div className="rounded-2xl bg-[#0F1F33]/90 px-8 py-10 backdrop-blur-xl">
            {success ? (
              <div className="text-center">
                <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-[#D4A03C]/10">
                  <svg className="h-7 w-7 text-[#D4A03C]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                ...
                <p className="mt-2 text-sm text-[#8A9AB5] leading-relaxed">
                  Se l&apos;indirizzo <strong className="text-white">{email}</strong> è associato a un account, riceverai un link per reimpostare la password.
                </p>
                ...
                <Link
                  ...
                  className="mt-6 inline-block text-sm text-[#D4A03C] hover:text-[#E8C06A] transition-colors"
                >
                  Torna al login
                </Link>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                {/* Email */}
                <div>
                  <label htmlFor="email" className="mb-1.5 block text-xs font-medium uppercase tracking-widest text-[#8A9AB5]">
                    Email
                  </label>
